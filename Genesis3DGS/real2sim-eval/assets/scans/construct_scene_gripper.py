...
def ransac_icp(scene_gs_input_path, robot_bbox, genesis_scene, do_visualization=True):
    voxel_size = 0.05
    ...
    # urdf_path = 'assets/robots/xarm/xarm7_with_gripper_collision.urdf'
    link_names = [
        'link1',
        'link2',
        'link3',
    ...
    sample_robot = RobotPcSampler(urdf_path, genesis_scene=genesis_scene)
...
if __name__ == '__main__':
    ...
    if args.construct:
        ...
        # gs_to_robo = ransac_icp(scene_gs_input_path, robot_bbox, scene, do_visualization=False)
        gs_to_robo = ransac_icp(scene_gs_input_path, robot_bbox, scene, do_visualization=True)
